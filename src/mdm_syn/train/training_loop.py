...
from src.mdm_syn.diffusion.resample import LossAwareSampler
from src.mdm_syn.diffusion.resample import create_named_schedule_sampler

from src.mdm_syn.eval import eval_humanml
from src.mdm_syn.eval.eval_mixamo import mixamo_evaluate

from sample.generate_syn import main as generate
    ...
    def evaluate(self):
        ...
        if self.eval_wrapper is not None:
            ...
            for m, vals in eval_dict.items():
                self.train_platform.report_scalar(name=m, value=vals['mean'], iteration=self.total_step(), group_name=f'Eval')
