...
from src.mdm_syn.motion.transforms import quat2mat, repr6d2mat, euler2mat
...
class ForwardKinematicsJoint:
    ...
    def forward(self, rotation: torch.Tensor, position: torch.Tensor, offset=None, world=True):
