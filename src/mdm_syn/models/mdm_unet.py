...
from src.mdm_syn.diffusion.fp16_util import convert_module_to_f16, convert_module_to_f32
from src.mdm_syn.diffusion.nn import (checkpoint, conv_nd, linear, avg_pool_nd,
                                      zero_module, normalization, timestep_embedding,)
from src.mdm_syn.models.qna import FusedQnA1d
...
class ResBlock(TimestepBlock):
    ...
    def __init__(
        ...
        self.emb_layers = nn.Sequential(
            nn.SiLU(),
            linear(emb_channels, 2 * self.out_channels if use_scale_shift_norm \
