...
DEFAULT_PATH = './src/mdm_prior/data_loaders/amass/deps/transforms/rots2rfeats/globalvelandy/rot6d/babel-amass'


class Rots2Rfeats(nn.Module):

    def __init__(self, path: Optional[str] = f"{DEFAULT_PATH}/separate_pairs",
                        normalization: bool = True, eps: float = 1e-12, **kwargs) -> None:
