...
from src.mdm_trans.utils.sample_utils import (
    get_niter, get_sample_vars, init_main, sample_motions, 
    get_xyz_rep, get_max_frames, prepare_plot, save_results,
)
...
def transfer(args, data, model, diffusion):
    ...
    if args.leader_motion_path or args.follower_motion_path:
        ...
        n_frames, inv_idx = merge_inverse_args(args, data, motions_to_invert_kwargs['y']['text'], 
