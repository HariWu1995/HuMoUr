...
from sample.generate_syn import load_dataset
...
def main():
    ...
    if model.data_rep == 'hml_vec':
        ...
        # n_samples x n_joints x n_features x n_frames ==> n_samples x n_frames x n_joints x n_features
        ...
        sample = xyz_samples.transpose(0, 2, 3, 1)
    ...
    if model.data_rep == 'hml_vec':
        ...
        # n_samples x n_frames x n_joints x 3  =>  n_samples x n_joints x 3 x n_frames
        input_motions = xyz_samples.transpose(0, 2, 3, 1)
