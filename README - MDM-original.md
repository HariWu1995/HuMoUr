...
```shell
python -m sample.generate --model_path ./save/humanml_trans_enc_512/model000200000.pt --input_text ./assets/MDM/example_text_prompts.txt
```
...
```shell
python -m sample.generate --model_path ./save/humanact12/model000350000.pt --action_file ./assets/MDM/example_action_names_humanact12.txt
```
...
![example](assets/MDM/edit/in_between_edit.gif)
...
![example](assets/MDM/edit/upper_body_edit.gif)
